...
namespace Storyunit.Controllers
{
    public class TijdschriftenController : Controller
    {
        ...
        {
            var tijdschrift = db.Tijdschrift.Include(t => t.Auteur).Include(t => t.Taal).Include(t => t.Tijdschrift1).Include(t => t.Tijdschrift2).Include(t => t.Uitgever);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.TijdschriftID = new SelectList(db.Tijdschrift, "TijdschriftID", "Titel");
            ViewBag.TijdschriftID = new SelectList(db.Tijdschrift, "TijdschriftID", "Titel");
        ...
        public ActionResult Create([Bind(Include = "TijdschriftID,AuteurID,UitgeverID,TaalID,Titel,Uitgifte,Afmeting,ISSN,Fotolink")] Tijdschrift tijdschrift)
        {
            ...
            ViewBag.TijdschriftID = new SelectList(db.Tijdschrift, "TijdschriftID", "Titel", tijdschrift.TijdschriftID);
            ViewBag.TijdschriftID = new SelectList(db.Tijdschrift, "TijdschriftID", "Titel", tijdschrift.TijdschriftID);
